...
public class ArrayIncrementalStreamsTest {
    private static final Logger logger = LoggerFactory.getLogger(ArrayIncrementalStreamsTest.class);
    public static final String SOLVER_CONFIG =
            "ai/timefold/solver/benchmarks/examples/curriculumcourse/curriculumTestArrayIncrementalSolverConfig.xml";
